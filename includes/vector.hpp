...
class vector {
 public:
  ...
  // element in a vector. typedef ft::random_access_iterator<T, T*, T&>
  // iterator;
  // // A type that provides a random-access iterator that can read a const
  // element in a vector. typedef ft::random_access_iterator<T, const T*, const
  // T&> const_iterator;
  // // A type that provides a random-access iterator that can read or modify
  // any element in a reversed vector. typedef std::reverse_iterator<iterator>
  // reverse_iterator;
  // // A type that provides a random-access iterator that can read any const
  // element in the vector. typedef std::reverse_iterator<const_iterator>
 ...
 public:
  ...
  explicit vector(size_type n, const value_type &val = value_type(),
    ...
    this->_vec = this->_alloc.allocate(sizeof(value_type) * n);
  ...
  vector(InputIterator first, InputIterator last,
    ...
    // 	this->_capacity++;
    // }
    // this->_vec = this->_alloc.allocate(sizeof()) // type은?
  ...
  const_iterator begin() const return (static_cast< const_iterator >(_vec));
